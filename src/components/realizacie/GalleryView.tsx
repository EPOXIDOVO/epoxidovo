      ...
      <div className="flex flex-wrap gap-1.5 md:gap-2">
        {options.map((opt) => (
          <button
            ...
            style={{ touchAction: "manipulation" }}
            className={cn(
              "whitespace-nowrap min-h-[40px] md:min-h-[44px] px-3.5 md:px-5 py-2 md:py-2.5 rounded-full text-[13px] md:text-base font-semibold transition-all duration-300 select-none cursor-pointer",
              active === opt.value
