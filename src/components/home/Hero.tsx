        ...
        >
          ...
          <div className="text-center max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl mx-auto rounded-3xl bg-[#0a0f1e]/80 backdrop-blur-md ring-1 ring-white/10 px-5 md:px-8 py-5 md:py-8 shadow-[0_20px_60px_rgba(0,0,0,0.4)] md:pointer-events-auto">
            ...
            <div className="mt-4 md:mt-8 grid grid-cols-2 gap-2 md:flex md:flex-wrap md:justify-center md:gap-3">
              ...
              <Link
                href="/eshop"
                className="relative col-span-2 md:col-auto inline-flex items-center justify-center gap-2 w-full md:w-auto px-4 md:px-7 py-2.5 md:py-3.5 rounded-full border-2 border-white/40 bg-white/5 text-white font-semibold text-[13px] md:text-[15px] tracking-tight hover:bg-white/15 hover:border-white/60 transition-all duration-300"
              >
