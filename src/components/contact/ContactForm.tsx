    ...
    >
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 rounded-xl border border-[var(--color-border-strong)] focus:outline-none focus:ring-2 focus:ring-[#3db6e8] focus:border-transparent text-sm resize-none"
        />
        {errors.message && (
  ...
  return (
    <div>
      ...
      <input
        ref={ref}
        id={inputId}
        className="w-full px-4 py-3 rounded-xl border border-[var(--color-border-strong)] focus:outline-none focus:ring-2 focus:ring-[#3db6e8] focus:border-transparent text-sm"
        {...rest}
      />
