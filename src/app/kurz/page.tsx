...
export const metadata: Metadata = {
  ...
  description:
    "Dvojdňový praktický kurz liatych epoxidových podláh v Ružomberku. Max. 6 ľudí, 80 % času s náradím v ruke, vlastná plocha 12 m², certifikát a 30 dní podpory.",
  alternates: { canonical: "/kurz" },
  openGraph: {
    title: "Kurz epoxidových podláh — EPOXIDOVO Akadémia",
    description:
      "Za dva dni sa naučíš liať podlahu, ktorú si zákazník odfotí. Praktický kurz v malej skupine.",
    url: "/kurz",
  },
};
...
const courseJsonLd = {
  ...
  name: KURZ.name,
  description:
    "Dvojdňový praktický kurz liatych epoxidových podláh — príprava podkladu, jednofarebná liata podlaha, chipsy, metalický efekt, detaily a cenotvorba.",
  provider: {
    "@type": "Organization",
    name: SITE.legalName,
    url: SITE.url,
  ...
  offers: {
    "@type": "Offer",
    price: KURZ.priceStandard,
    priceCurrency: "EUR",
    availability: "https://schema.org/InStock",
    url: `${SITE.url}/kurz`,
  },
  hasCourseInstance: KURZ.nextTerms.map((t) => ({
    "@type": "CourseInstance",
    courseMode: "onsite",
    name: `${KURZ.shortName} — ${t.date}`,
    location: {
      "@type": "Place",
      name: KURZ.place,
      address: {
